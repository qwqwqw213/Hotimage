...
//              anchors.centerIn: parent
          ...
          MouseArea {
              ...
              onMouseYChanged: {
                  if( dragFlag ) {
                      image.x = mouseX - pressedX + currentX
                      image.y = mouseY - pressedY + currentY
//                      console.log((mouseY - pressedY + currentY) / wrapper.height)
                  }
                  else {
...
//                      image.y = 0
                      ...
                      console.log(rect.x, rect.y, rect.w, rect.h, rect.pw, rect.ph)
                  }
              }
